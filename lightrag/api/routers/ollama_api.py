...
class OllamaAPI:
    ...
    async def _get_rag(self, request: Request | None = None) -> LightRAG:
        if self._rag_single is not None:
    ...
    async def _get_ollama_server_infos(self, request: Request | None = None):
        ...
        return rag.ollama_server_infos
    ...
    def setup_routes(self):
        ...
        async def get_tags(raw_request: Request):
            ...
            ollama_server_infos = await self._get_ollama_server_infos(raw_request)
        ...
        async def generate(raw_request: Request):
            ...
            try:
                ...
                rag = await self._get_rag(raw_request)
                ollama_server_infos = await self._get_ollama_server_infos(raw_request)
