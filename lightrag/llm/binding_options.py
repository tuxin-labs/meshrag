...
class OpenAILLMOptions(BindingOptions):
    ...
    default_headers: dict = None  # Custom HTTP headers for OpenAI-compatible clients
    ...
    _help: ClassVar[dict[str, str]] = {
        ...
        "default_headers": (
            "Custom HTTP headers for OpenAI-compatible APIs (JSON dict, e.g., "
            '\'{"X-Apig-AppCode": "your-app-code"}\')'
        ),
    }
