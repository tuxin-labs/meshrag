...
class TestMilvusIndexConfig:
    ...
    def test_build_index_params_autoindex(self):
        """Test AUTOINDEX still calls add_index but returns the index_params"""
        ...
        # AUTOINDEX 调用 add_index 并返回 index_params（非 None）
    ...
    def test_build_index_params_with_none(self):
        """Test that passing None returns None (graceful handling)"""
        config = MilvusIndexConfig(index_type="HNSW")
